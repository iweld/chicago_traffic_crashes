...
COPY crashes
FROM
'path\to\your\csv\chicago_traffic_crashes_part_1.csv'
DELIMITER ',' CSV HEADER;

COPY crashes
FROM
'path\to\your\csv\chicago_traffic_crashes_part_2.csv'
DELIMITER ',' CSV HEADER;

COPY crashes
FROM
'path\to\your\csv\chicago_traffic_crashes_part_3.csv'
DELIMITER ',' CSV HEADER;
...
>>>>>>> fdc3a22ec822e7203684f987f19299c933dfc410
