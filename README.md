...
## Datasets used
Due to the file size restriction on Github, the following [dataset](https://github.com/iweld/chicago_traffic_crashes/tree/main/csv) for this case study has been split into three (3) individual files.
